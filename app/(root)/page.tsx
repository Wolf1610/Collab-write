          ...
          <div>
            <ul>
              {roomDocuments.data.map(({ id, metadata, createdAt }: any) => (
                <li key={id} className="mb-4 bg-[#191919]">
                  <Link
                    href={`/documents/${id}`}
                    className="flex justify-start items-center gap-4 py-2 px-2 border border-white/20 rounded-sm"
                  >
                    ...
                    <div className="space-y-1">
                      <p className="line-clamp-1 text-md text-white">{metadata.title}</p>
